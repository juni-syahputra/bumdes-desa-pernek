...
if( empty( $_SESSION['iduser'] ) ){
	...
	*/
	echo '<h2>Pembayaran barang</h2><hr>';
...
<form class="form-horizontal" role="form" method="post" action="./admin.php?hlm=bayar">
  <div class="form-group">
    <label for="nis" class="col-sm-2 control-label">kode pembayaran</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="nis" name="nis" placeholder="kode pembauaran" required autofocus>
    </div>
  </div>
  <div class="form-group">
