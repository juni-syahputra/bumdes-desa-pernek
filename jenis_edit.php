...
<form method="post" action="admin.php?hlm=master&sub=jenis&aksi=edit" class="form-horizontal" role="form">
	<div class="form-group">
		<label for="tapel" class="col-sm-2 control-label">Tahun pembayaran </label>
		<div class="col-sm-2">
	...
	<div class="form-group">
		...
		<div class="col-sm-2">
			<select name="tingkat" id="tingkat" class="form-control">
				<option value="X" selected="selected"<?php echo ($tk=='X') ? 'selected' : ''; ?>>I (satu)</option>
				<option value="XI"<?php echo ($tk=='XI') ? 'selected' : ''; ?>>II (dua)</option>
				<option value="XII"<?php echo ($tk=='XII') ? 'selected' : ''; ?>>III (tiga)</option>
			</select>
		</div>
	</div>
	<div class="form-group">
