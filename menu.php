...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  <div class="container">
	<div class="navbar-header">
	  ...
	  <a class="navbar-brand" href="#"><span class="glyphicon glyphicon-fire"></span>GO BUMDES </a></div>
	<div class="navbar-collapse collapse">
	  <ul class="nav navbar-nav">
		...
		<li class="dropdown">
		  ...
		  <ul class="dropdown-menu">
			<li><a href="./admin.php?hlm=master&sub=jurusan">Jenis barang </a></li>
			<li><a href="./admin.php?hlm=master&sub=siswa">Barang</a></li>
			<li><a href="./admin.php?hlm=master&sub=kelas">Kelasifikasi barang </a></li>
			<?php
			if( $_SESSION['admin'] == 1 ){
			?>
			<li class="divider"></li>
			...
			<li class="divider"></li>
			<li><a href="./admin.php?hlm=master&sub=tapel">Tahun pembayaran </a></li>
			<?php
			}
			?>
		  </ul>
